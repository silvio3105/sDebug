...
#ifdef DEBUG_MODULE_VERBOSE
DEBUG_ENABLE_VERBOSE(MODULE);
#else // DEBUG_MODULE_VERBOSE
DEBUG_DISABLE_VERBOSE(MODULE);
#endif // DEBUG_MODULE_VERBOSE

#ifdef DEBUG_MODULE_INFO
DEBUG_ENABLE_INFO(MODULE);
#else // DEBUG_MODULE_INFO
DEBUG_DISABLE_INFO(MODULE);
#endif // DEBUG_MODULE_INFO

#ifdef DEBUG_MODULE_ERROR
DEBUG_ENABLE_ERROR(MODULE);
#else // DEBUG_MODULE_ERROR
DEBUG_DISABLE_ERROR(MODULE);
#endif // DEBUG_MODULE_ERROR
